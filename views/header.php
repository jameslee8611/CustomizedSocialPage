...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo URL; ?>public/css/custom-foundation.css" />
        <link rel="stylesheet" href="<?php echo URL; ?>public/css/common.css" />
        <link rel="stylesheet" href="<?php echo URL; ?>public/css/foundation-icons/foundation-icons.css" />
        <link rel="stylesheet" href="<?php echo URL; ?>public/css/cropper.css" />
        ...
        <script type="text/javascript" src="<?php echo URL; ?>public/js/cropper.js"></script>
    </head>
    <body>